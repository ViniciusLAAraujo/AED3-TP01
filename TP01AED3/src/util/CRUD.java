...
public class CRUD {
	...
	public static int read(String searchUser, RandomAccessFile arq) throws IOException {
		...
		do {
			try {
				...
				if (tmpLapid == 0) {
					...
					if (searchUser.equals(tmpAcc.getNomeUsuario())) {
	...
	public static boolean delete(String searchUser, RandomAccessFile arq) throws IOException {
	...
	public static boolean update(Conta tmpAcc, RandomAccessFile arq) throws IOException {
		...
		position =CRUD.read(tmpAcc.getNomeUsuario(), arq);
